...
namespace IntegriraniSistemiH1.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DatePurchased")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,DatePurchased")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
